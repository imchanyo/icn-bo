...
import { Eye, EyeOff } from "lucide-react"; // 눈 아이콘
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <Button
              type="submit"
              size="lg"
              className="w-full bg-[var(--color-button-bg)] hover:bg-[var(--color-button-hover-bg)] text-white font-semibold rounded-lg transition-all"
            >
              로그인
            </Button>
          </form>
